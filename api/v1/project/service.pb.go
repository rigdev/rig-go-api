...
func file_api_v1_project_service_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1_project_service_proto_msgTypes[21].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_project_service_proto_msgTypes[22].Exporter = func(v interface{}, i int) interface{} {
