...
type RolloutProposal struct {
	...
	RepoBranch    *model.RepoBranch      `protobuf:"bytes,10,opt,name=repo_branch,json=repoBranch,proto3" json:"repo_branch,omitempty"`
	ReviewUrl     string                 `protobuf:"bytes,11,opt,name=review_url,json=reviewUrl,proto3" json:"review_url,omitempty"`
}

func (x *RolloutProposal) Reset() {
	*x = RolloutProposal{}
	if protoimpl.UnsafeEnabled {
...
func (x *RolloutProposal) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*RolloutProposal) ProtoMessage() {}

func (x *RolloutProposal) ProtoReflect() protoreflect.Message {
	mi := &file_api_v1_capsule_rollout_proto_msgTypes[4]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use RolloutProposal.ProtoReflect.Descriptor instead.
func (*RolloutProposal) Descriptor() ([]byte, []int) {
	return file_api_v1_capsule_rollout_proto_rawDescGZIP(), []int{4}
}

func (x *RolloutProposal) GetProjectId() string {
	if x != nil {
		return x.ProjectId
	}
	return ""
...
func (x *RolloutProposal) GetEnvironmentId() string {
	if x != nil {
		return x.EnvironmentId
	}
	return ""
...
func (x *RolloutProposal) GetCapsuleId() string {
	if x != nil {
		return x.CapsuleId
	}
	return ""
...
func (x *RolloutProposal) GetBranchName() string {
	if x != nil {
		return x.BranchName
	}
	return ""
...
func (x *RolloutProposal) GetSpec() *v1.CapsuleSpec {
	if x != nil {
		return x.Spec
	}
	return nil
...
func (x *RolloutProposal) GetChanges() []*Change {
	if x != nil {
		return x.Changes
	}
	return nil
...
func (x *RolloutProposal) GetCreatedAt() *timestamppb.Timestamp {
	if x != nil {
		return x.CreatedAt
	}
	return nil
...
func (x *RolloutProposal) GetCreatedBy() *model.Author {
	if x != nil {
		return x.CreatedBy
	}
	return nil
...
func (x *RolloutProposal) GetProposalId() string {
	if x != nil {
		return x.ProposalId
	}
	return ""
...
func (x *RolloutProposal) GetRepoBranch() *model.RepoBranch {
	if x != nil {
		return x.RepoBranch
	}
	return nil
...
func (x *RolloutProposal) GetReviewUrl() string {
	if x != nil {
		return x.ReviewUrl
	}
	return ""
...
var file_api_v1_capsule_rollout_proto_rawDesc = []byte{
	...
	0x63, 0x61, 0x70, 0x73, 0x75, 0x6c, 0x65, 0x73, 0x22, 0xd4, 0x03, 0x0a, 0x0f, 0x52, 0x6f, 0x6c,
	0x6c, 0x6f, 0x75, 0x74, 0x50, 0x72, 0x6f, 0x70, 0x6f, 0x73, 0x61, 0x6c, 0x12, 0x1d, 0x0a, 0x0a,
	...
	0x6d, 0x65, 0x12, 0x2c, 0x0a, 0x04, 0x73, 0x70, 0x65, 0x63, 0x18, 0x05, 0x20, 0x01, 0x28, 0x0b,
	...
	0x12, 0x30, 0x0a, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x73, 0x18, 0x06, 0x20, 0x03, 0x28,
	0x0b, 0x32, 0x16, 0x2e, 0x61, 0x70, 0x69, 0x2e, 0x76, 0x31, 0x2e, 0x63, 0x61, 0x70, 0x73, 0x75,
	0x6c, 0x65, 0x2e, 0x43, 0x68, 0x61, 0x6e, 0x67, 0x65, 0x52, 0x07, 0x63, 0x68, 0x61, 0x6e, 0x67,
	...
	,
...
var file_api_v1_capsule_rollout_proto_goTypes = []interface{}{
	...
	(*RolloutProposal)(nil),        // 5: api.v1.capsule.RolloutProposal
...
var file_api_v1_capsule_rollout_proto_depIdxs = []int32{
	...
	8,  // 19: api.v1.capsule.RolloutProposal.spec:type_name -> platform.v1.CapsuleSpec
	11, // 20: api.v1.capsule.RolloutProposal.changes:type_name -> api.v1.capsule.Change
	10, // 21: api.v1.capsule.RolloutProposal.created_at:type_name -> google.protobuf.Timestamp
	9,  // 22: api.v1.capsule.RolloutProposal.created_by:type_name -> model.Author
	17, // 23: api.v1.capsule.RolloutProposal.repo_branch:type_name -> model.RepoBranch
