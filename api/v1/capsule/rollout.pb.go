...
var file_api_v1_capsule_rollout_proto_rawDesc = []byte{
	...
	0x73, 0x52, 0x06, 0x73, 0x74, 0x61, 0x74, 0x75, 0x73, 0x22, 0xaa, 0x05, 0x0a, 0x0d, 0x52, 0x6f,
	...
	0x65, 0x73, 0x73, 0x61, 0x67, 0x65, 0x22, 0xc0, 0x01, 0x0a, 0x0a, 0x43, 0x6f, 0x6e, 0x66, 0x69,
	...
	0x08, 0x69, 0x73, 0x53, 0x65, 0x63, 0x72, 0x65, 0x74, 0x2a, 0x3d, 0x0a, 0x09, 0x45, 0x76, 0x65,
...
var file_api_v1_capsule_rollout_proto_msgTypes = make([]protoimpl.MessageInfo, 3)
var file_api_v1_capsule_rollout_proto_goTypes = []interface{}{
	...
	(*rollout.Status)(nil),        // 4: api.v1.capsule.rollout.Status
	...
	(*HorizontalScale)(nil),       // 10: api.v1.capsule.HorizontalScale
	(*CronJob)(nil),               // 11: api.v1.capsule.CronJob
}
var file_api_v1_capsule_rollout_proto_depIdxs = []int32{
	...
	4,  // 1: api.v1.capsule.Rollout.status:type_name -> api.v1.capsule.rollout.Status
	5,  // 2: api.v1.capsule.RolloutConfig.created_by:type_name -> model.Author
	6,  // 3: api.v1.capsule.RolloutConfig.created_at:type_name -> google.protobuf.Timestamp
	7,  // 4: api.v1.capsule.RolloutConfig.changes:type_name -> api.v1.capsule.Change
	8,  // 5: api.v1.capsule.RolloutConfig.network:type_name -> api.v1.capsule.Network
	9,  // 6: api.v1.capsule.RolloutConfig.container_settings:type_name -> api.v1.capsule.ContainerSettings
	3,  // 7: api.v1.capsule.RolloutConfig.config_files:type_name -> api.v1.capsule.ConfigFile
	10, // 8: api.v1.capsule.RolloutConfig.horizontal_scale:type_name -> api.v1.capsule.HorizontalScale
	11, // 9: api.v1.capsule.RolloutConfig.cron_jobs:type_name -> api.v1.capsule.CronJob
	5,  // 10: api.v1.capsule.ConfigFile.updated_by:type_name -> model.Author
	6,  // 11: api.v1.capsule.ConfigFile.updated_at:type_name -> google.protobuf.Timestamp
