...
var file_api_v1_capsule_capsule_proto_rawDesc = []byte{
	...
	0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x22, 0x48, 0x0a, 0x06, 0x55, 0x70, 0x64, 0x61, 0x74, 0x65,
	0x12, 0x35, 0x0a, 0x0d, 0x73, 0x65, 0x74, 0x5f, 0x67, 0x69, 0x74, 0x5f, 0x73, 0x74, 0x6f, 0x72,
	0x65, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x0f, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x2e,
	0x47, 0x69, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x48, 0x00, 0x52, 0x0b, 0x73, 0x65, 0x74, 0x47,
	0x69, 0x74, 0x53, 0x74, 0x6f, 0x72, 0x65, 0x42, 0x07, 0x0a, 0x05, 0x66, 0x69, 0x65, 0x6c, 0x64,
...
var file_api_v1_capsule_capsule_proto_goTypes = []any{
...
var file_api_v1_capsule_capsule_proto_depIdxs = []int32{
	...
	4, // 3: api.v1.capsule.Update.set_git_store:type_name -> model.GitStore
...
func file_api_v1_capsule_capsule_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_capsule_capsule_proto_msgTypes[0].Exporter = func(v any, i int) any {
		...
		file_api_v1_capsule_capsule_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Update); i {
			case 0:
				return &v.state
			case 1:
	...
	file_api_v1_capsule_capsule_proto_msgTypes[1].OneofWrappers = []any{
