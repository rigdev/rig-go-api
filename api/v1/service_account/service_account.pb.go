...
var file_api_v1_service_account_service_account_proto_goTypes = []any{
...
func file_api_v1_service_account_service_account_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_service_account_service_account_proto_msgTypes[0].Exporter = func(v any, i int) any {
