...
var file_api_v1_group_group_proto_goTypes = []any{
...
func file_api_v1_group_group_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		file_api_v1_group_group_proto_msgTypes[0].Exporter = func(v any, i int) any {
			switch v := v.(*Group); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1_group_group_proto_msgTypes[1].Exporter = func(v any, i int) any {
			switch v := v.(*Update); i {
			case 0:
				return &v.state
			case 1:
		...
		file_api_v1_group_group_proto_msgTypes[2].Exporter = func(v any, i int) any {
	...
	file_api_v1_group_group_proto_msgTypes[1].OneofWrappers = []any{
		(*Update_GroupId)(nil),
		(*Update_SetMetadata)(nil),
		(*Update_DeleteMetadataKey)(nil),
	}
	file_api_v1_group_group_proto_msgTypes[2].OneofWrappers = []any{
