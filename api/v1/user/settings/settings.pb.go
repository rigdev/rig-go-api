...
func file_api_v1_user_settings_settings_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[11].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[12].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[13].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[14].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[15].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[16].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[17].Exporter = func(v interface{}, i int) interface{} {
		...
		file_api_v1_user_settings_settings_proto_msgTypes[18].Exporter = func(v interface{}, i int) interface{} {
	...
	file_api_v1_user_settings_settings_proto_msgTypes[8].OneofWrappers = []interface{}{
		(*EmailInstance_Default)(nil),
		(*EmailInstance_Mailjet)(nil),
		(*EmailInstance_Smtp)(nil),
	}
	file_api_v1_user_settings_settings_proto_msgTypes[9].OneofWrappers = []interface{}{
