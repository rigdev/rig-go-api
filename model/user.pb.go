...
var file_model_user_proto_rawDesc = []byte{
	...
	0x65, 0x74, 0x68, 0x6f, 0x64, 0x52, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x22, 0xcf, 0x01,
	...
	0x6e, 0x54, 0x79, 0x70, 0x65, 0x42, 0x08, 0x0a, 0x06, 0x6d, 0x65, 0x74, 0x68, 0x6f, 0x64, 0x42,
	0x6e, 0x0a, 0x09, 0x63, 0x6f, 0x6d, 0x2e, 0x6d, 0x6f, 0x64, 0x65, 0x6c, 0x42, 0x09, 0x55, 0x73,
	0x65, 0x72, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01, 0x5a, 0x22, 0x67, 0x69, 0x74, 0x68, 0x75,
...
var file_model_user_proto_depIdxs = []int32{
	...
	9,  // 3: model.ServiceAccountEntry.created_at:type_name -> google.protobuf.Timestamp
	10, // 4: model.ServiceAccountEntry.created_by:type_name -> model.Author
	...
	9,  // 7: model.MemberEntry.joined_at:type_name -> google.protobuf.Timestamp
	...
	11, // 11: model.RegisterMethod.Signup.login_type:type_name -> model.LoginType
...
func file_model_user_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_user_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_model_user_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_model_user_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_model_user_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_model_user_proto_msgTypes[6].Exporter = func(v any, i int) any {
		...
		file_model_user_proto_msgTypes[7].Exporter = func(v any, i int) any {
		...
		file_model_user_proto_msgTypes[8].Exporter = func(v any, i int) any {
	...
	file_model_user_proto_msgTypes[0].OneofWrappers = []any{
		(*UserIdentifier_Username)(nil),
		(*UserIdentifier_Email)(nil),
		(*UserIdentifier_PhoneNumber)(nil),
	}
	file_model_user_proto_msgTypes[4].OneofWrappers = []any{
		(*MemberEntry_User)(nil),
		(*MemberEntry_ServiceAccount)(nil),
	}
	file_model_user_proto_msgTypes[6].OneofWrappers = []any{
