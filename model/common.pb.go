...
func file_model_common_proto_init() {
	...
	if !protoimpl.UnsafeEnabled {
		...
		file_model_common_proto_msgTypes[1].Exporter = func(v any, i int) any {
		...
		file_model_common_proto_msgTypes[2].Exporter = func(v any, i int) any {
		...
		file_model_common_proto_msgTypes[3].Exporter = func(v any, i int) any {
		...
		file_model_common_proto_msgTypes[4].Exporter = func(v any, i int) any {
		...
		file_model_common_proto_msgTypes[5].Exporter = func(v any, i int) any {
		...
		file_model_common_proto_msgTypes[6].Exporter = func(v any, i int) any {
	...
	file_model_common_proto_msgTypes[4].OneofWrappers = []any{
		(*HashingConfig_Bcrypt)(nil),
		(*HashingConfig_Scrypt)(nil),
	}
	file_model_common_proto_msgTypes[5].OneofWrappers = []any{
